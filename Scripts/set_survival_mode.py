"""
set_survival.py — Manually invoke Survival Mode (M4 Point 6A)
...
from core.runtime_mode import set_survival_mode
from core.logger import get_logger

log = get_logger("set_survival")


def main() -> None:
    state = set_survival_mode(reason="manual_cli")
    log.info(
        f"device.mode.set | mode=survival "
    ...
    try:
        ...
        log.warning(f"set_survival.announce_failed | {e}")
